using ShopperAE.Areas.Shopper.Models;
using System;
...
namespace ShopperAE.Areas.Shopper.Controllers
{
    public class ThanhToanController : Controller
    {
        ...
        public ActionResult StepEnd()
        {
            ...
            Session["Phone"] = phone;
            Session["cusFullName"] = fullname;
            Session["cusEmail"] = email;
            Session["cusAddress"] = address;
            Session["orderMessage"] = note;
